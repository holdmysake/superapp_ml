...
PIPELINES = {
    ...
    "KAS → TPN": {
        ...
        "default_normal": [162.914, 113.014, 76.77, 15.206],
        "default_drop":   [154.265, 96.025, 69.383, 14.989],
        "historical_data": [
...
{"sensor_normal": [162.914, 113.014, 76.77, 15.206], "sensor_drop": [154.265, 96.025, 69.383, 14.989], "actual_leak_km": 5.5},  #tgl 20 agustus 2026
    ...
    "BJG → TPN": {
        ...
        "historical_data": [
            ...
            {"sensor_normal": [1.02, 0.27, 39.7, 11.75], "sensor_drop": [1.02, 0.01, 32.3, 6.3],  "actual_leak_km": 10.39},
        ],
    },
